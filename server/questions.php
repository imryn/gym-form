<?php
    ...
    class Questions{
        ...
        public function createQuestionsFormForUser(){
            ...
            '{$_POST['swimming']}','{$_POST['aerobic_exercises']}','{$_POST['unaerobic_exercises']}','{$_POST['gymsport']}','{$_POST['training_frequency']}',
            ...
            $sql = "INSERT INTO questions (userid,bicycle,goingtogym,martialarts,game,running,swimming,aerobic_exercises,
            unaerobic_exercises,gymsport,training_frequency,training_favorite_time,balance,cardio,
