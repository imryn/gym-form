<?php
    ...
    class Questions{
        ...
        public function createQuestionsFormForUser(){
            ...
            $values = "'{$_SESSION['userid']}','{$_POST['bicycle']}','{$_POST['martialarts']}','{$_POST['game']}','{$_POST['running']}',
            ...
            $sql = "INSERT INTO questions (userid,bicycle,martialarts,game,running,swimming,unoraerobic_exercises,
